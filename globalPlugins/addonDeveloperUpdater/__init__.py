...
class IssueTemplateEditorDialog(wx.Dialog):
    ...
    def _createFormPage(self):
        ...
        if self.document.kind == "markdown":
            ...
            self.markdownBody.SetName(_("Instructions and questions shown to the person opening the issue"))
    ...
    def _enableQuestionFields(self):
        ...
        valueLabel = _("Information text shown in the issue form, written in Markdown:") if markdown else _("Answer filled in before the person starts typing:"); self.questionValueLabel.SetLabel(valueLabel); self.questionValue.SetName(valueLabel.rstrip(":"))
